...
import 'package:voice_search_app/secrets.dart';
            ...
            "messages": [
              {
                'role': 'user',
                'content':
                    'Does this message want to generate an AI art , image, picture or anything similar? $prompt . Simply answer with a yes or no.',
              }
            ]
          }));
